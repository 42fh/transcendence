...
window.addEventListener('resourcesLoaded', () => {
    ...
    // paddle 1
    const playerGeometry = new THREE.BoxGeometry(PADDLE_SIZE / 2, 0.1, PADDLE_SIZE);
    player1 = new THREE.Mesh(playerGeometry, new THREE.MeshPhongMaterial({ color: 0xff0000 }));
    player1.castShadow = true;
    player1.receiveShadow = true;
    player1.position.set(GAME_HEIGHT - GAME_HEIGHT - 0.04, 0.05, GAME_HEIGHT / 2 - PADDLE_SIZE / 2);
    player1.scale.set(1, 1, 1);
    playerGeometry.translate(0, 0, PADDLE_SIZE / 2);

    // paddle 2
    player2 = player1.clone();
    player2.position.set(GAME_HEIGHT + 0.04, 0.05, GAME_HEIGHT / 2 - PADDLE_SIZE / 2);
