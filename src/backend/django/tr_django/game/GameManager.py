...
class GameManager:
    ...
    def __init__(self, game_id):
        ...
        #
        self.num_balls = 1  # later to be NONE. get value in self.init_game_state()
        self.running = False
            ...
            "balls": [
                {
                    "x": 0.5,
                    "y": 0.5,
                    "velocity_x": 0.004 * (i + 1) * (1 if i % 2 == 0 else -1),
                    "velocity_y": 0.004 * (i + 1) * (1 if i % 2 == 0 else -1),
    ...
    async def update_game(self):
        ...
        if game_over:
            ...
            # In case of a tie, the first player to reach the score wins
            if winning_indices:
    ...
    def game_logic(self, current_state):
        ...
        for ball in current_state["balls"]:
    ...
    async def add_player(self, player_id):
        ...
        if player_id not in self.players:
            ...
            return self.players.index(player_id) if player_id in self.players else None
