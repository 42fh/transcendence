...
class BallUtils:
    ...
    @staticmethod
    def reset_ball_position(ball: Dict, active_sides: List[int], initial_speed: float) -> Dict:
        """Reset ball to center with new random direction."""
        velocity_x, velocity_y = BallUtils.get_random_direction(active_sides, initial_speed)
