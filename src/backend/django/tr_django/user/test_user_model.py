...
class UserProfileTests(TestCase):
    def setUp(self):
        ...
        self.user_profile1 = UserProfile.objects.create(user=self.user1, bio="Test bio 1", location="Location 1", level=1)
        self.user_profile2 = UserProfile.objects.create(user=self.user2, bio="Test bio 2", location="Location 2", level=2)
    ...
    def test_add_self_as_friend(self):
        ...
        self.assertEqual(str(context.exception), "A user cannot add themselves as a friend.")
